...
async function requestHumanSupervision(context, systemState, timestamp): Promise<any> {
...
async function processHumanApproval(context, systemState, timestamp): Promise<any> {
...
async function processHumanRejection(context, systemState, timestamp): Promise<any> {
...
async function getSupervisionStatus(systemState, timestamp): Promise<any> {
  return {
    ...
    currentStatus: systemState.supervisionRequired
