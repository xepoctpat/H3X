...
async function testGenerativeCapabilities() {
  ...
  try {
    ...
    console.log("Tool ID:", analysisToolResponse.data.toolCode?.includes('TOOL_') ? 'Generated' : 'Error');
    ...
    console.log("Integration Code Available:", endpointResponse.data.integrationCode ? 'Yes' : 'No');
    console.log("");
    ...
    console.log("Files Generated:", Object.keys(projectResponse.data.structure?.files || {}).length);
    ...
    // Summary
    console.log(`${colors.bright}${colors.green}🎯 GENERATIVNE SKRIPTE POTPUNO FUNKCIONALNE!${colors.reset}`);
    ...
    console.log("");
    console.log(`${colors.cyan}🔮 Hexperiment Labs Framework - Code Generation Engine ACTIVE!${colors.reset}`);
...
async function interactiveTest() {
  ...
  function askQuestion() {
    console.log(`${colors.bright}${colors.cyan}🔮 H3X Generative Scripts Interactive Test${colors.reset}`);
...
async function testSingleGenerator(endpoint, data) {
  try {
